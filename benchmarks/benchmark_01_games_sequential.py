...
def run_benchmark():
    print("\n" + "="*80)
    print("Benchmark 01: Games - Índice Sequential")
    print("="*80)
    ...
    for csv_path, size_label in datasets:
        ...
        start = time.time()
        query = f"CREATE TABLE {table_name} FROM FILE '{csv_path}' USING PRIMARY INDEX SEQ(AppID), INDEX HASH(Name);"
    ...
    print("\n" + "="*80)
    print("Comparación Final - Sequential")
    print("="*80)
