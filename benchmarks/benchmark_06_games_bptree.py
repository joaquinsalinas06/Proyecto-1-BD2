"""
Benchmark 04: Games B+ Tree File Index + Hash
...
def run_benchmark():
    """Execute complete benchmark for Games dataset with B+ Tree File + Hash"""

    print("\n" + "="*80)
    print("BENCHMARK 04: GAMES - B+ Tree FILE INDEX + HASH")
    print("="*80)
    ...
    for csv_path, size_label in datasets:
        ...
        table_name = f"games_bptree_{size_label.lower()}"
        ...
        try:
            ...
            if metadata_path.exists():
                try:
                    ...
                    tables_to_remove = [k for k in metadata.keys() if k.startswith('airbnb_bptree_')]
            ...
            start = time.time()
            create_sql = f"CREATE TABLE {table_name} FROM FILE '{temp_bulk_csv}' USING PRIMARY INDEX BTREE(AppID), INDEX HASH(Name);"
            print(f"   📝 {create_sql}")
            tm.sql(create_sql)
            ...
            print(f"   ✅ Índice B+ Tree optimiza búsquedas exactas")
            ...
            print(f"   ✅ Índice B+ Tree permite escaneo de rangos")
    ...
    print("\n" + "="*140)
    print("RESUMEN DE RENDIMIENTO - B+ Tree FILE + HASH INDEX")
    print("="*140)
    ...
    print("\n" + "="*140)
    print("RESUMEN DE ESTADÍSTICAS DE I/O - B+ Tree FILE + HASH INDEX")
    print("="*140)
    ...
    print("   ✅ B+ Tree (AppID): Búsqueda exacta y rangos - INDEXADO")
